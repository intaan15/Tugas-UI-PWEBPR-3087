        ...
        <div class="kanan">
            <div class="isikanan">
                ...
                <div class="formregis">
                    ...
                    <input type="email" id="email" placeholder="Input email" autocomplete="off">
                    <i class="icon"></i>
                </div>    
                <div class="formregis">
                    <label for="nama1">Username</label>
                    <input type="text" id="nama1" placeholder="Username" autocomplete="off">
                    <i class="icon"></i>
                </div>
                <div class="formregis">
                ...
                <div class="tanya">
                    ...
                    <a class="tanya2" href="index.php">Login</a>
                </div>
